...
# -*- coding: utf-8 -*-
"""
finetune_exp7c_ecgfounder_v3.py — 仅加入 ECGFounder 筛选的真实相似正常拍
================================================================================
...
输出：
  models/best_resnet_large_exp7c_ecgfounder_v3.h5
  models/train_history_exp7c_ecgfounder_v3.csv
  models/deploy_match/finetune_exp7c_ecgfounder_v3.json
"""
...
OUT_H5 = MODELS / "best_resnet_large_exp7c_ecgfounder_v3.h5"
OUT_CSV = MODELS / "train_history_exp7c_ecgfounder_v3.csv"
OUT_JSON = CACHE / "finetune_exp7c_ecgfounder_v3.json"
...
def main():
    ...
    pub_normal = np.load(EGF_DIR / "real_like_normal_beats.npy").astype(np.float32)
