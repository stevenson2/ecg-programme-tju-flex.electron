#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""eval_event_v3b_sweep_high.py — exp7c INT8 vs ECGFounder v3b QAT INT8 事件级 1-of-5
================================================================================
...
OUT = Path(__file__).resolve().parent / "models" / "deploy_match" / "event_v3b_sweep_high.json"
