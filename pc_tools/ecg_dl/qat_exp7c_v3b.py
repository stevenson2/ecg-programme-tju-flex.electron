#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""qat_exp7c_v3b.py — exp7c_ecgfounder_v3 INT8 QAT (MIT 加强版)
================================================================================
目的：
...
流程：
  ...
  4. 导出 INT8 TFLite: models/ecg_model_exp7c_ecgfounder_v3b_qat_int8.tflite
"""
import sys, os, time
...
OUT_TFLITE = MODELS / "ecg_model_exp7c_ecgfounder_v3b_qat_int8.tflite"
OUT_JSON = MODELS / "qat_exp7c_v3b.json"
SEED = 42
