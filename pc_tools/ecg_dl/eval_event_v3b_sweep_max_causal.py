#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""eval_event_v3b_sweep_max_causal.py — exp7c INT8 vs ECGFounder v3b QAT INT8 事件级 1-of-5
================================================================================
...
_pol.THETAS = [0.75, 0.80, 0.82, 0.85, 0.88, 0.90]
from eval_aami_matrix import add_channel_dim

OUT = Path(__file__).resolve().parent / "models" / "deploy_match" / "event_v3b_sweep_max_causal.json"
